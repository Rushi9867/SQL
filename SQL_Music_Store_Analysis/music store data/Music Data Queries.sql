...
/* source: Youtube Link: https://youtu.be/VFIuIjswMKM?si=CSjBrnB7OPyU4hQz */
...
SELECT c.customer_id,c.first_name,c.last_name,SUM(i.total) AS Total_Spending  FROM customer c
JOIN invoice i ON c.customer_id = i.customer_id
GROUP BY c.customer_id,c.first_name,c.last_name ORDER BY Total_Spending DESC LIMIT 1;
